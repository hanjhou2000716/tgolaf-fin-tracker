  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .percent { color:var(--navy); font-variant-numeric:tabular-nums; text-align:right; font-weight:700; }
     .risk-group{padding:15px;border:1px solid #e3dfd6;border-radius:14px;background:#f4f2ed}.risk-group+.risk-group{margin-top:12px}.risk-group-title{display:flex;justify-content:space-between;align-items:baseline;margin-bottom:11px;font:700 17px Georgia,"Noto Serif TC",serif}.risk-group-title span{font:400 11px ui-sans-serif,sans-serif;color:var(--muted)}.risk-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.risk-box{min-width:0;padding:15px;border:1px solid #d5ded8;border-radius:12px;background:#f8faf7}.risk-box label{display:block;color:var(--muted);font-size:12px;font-weight:700}.risk-box strong{display:block;margin-top:7px;color:var(--navy);font-size:28px;line-height:1.1;letter-spacing:-.02em}.risk-divider{border:0;border-top:1px solid #d5ddd5;margin:12px 0 10px}.risk-card-detail,.risk-card-subdetail,.risk-card-status{display:block;line-height:1.45}.risk-card-detail{color:var(--ink);font-size:13px;font-weight:700}.risk-card-subdetail{margin-top:4px;color:var(--muted);font-size:12px}.risk-card-status{margin-top:8px;font-size:12px;font-weight:700}.risk-box strong.alert{color:var(--brick)}.risk-badge{display:inline-block;margin-top:5px;padding:4px 9px;border-radius:999px;background:#eadcad;color:#936a28;font-weight:800}.buyhold-primary{display:grid;grid-template-columns:minmax(0,1fr) minmax(150px,.72fr);align-items:stretch;gap:10px;padding:12px 13px;border-radius:12px;background:#f8faf7;border:1px solid #d5ded8}.buyhold-primary-content{display:flex;min-width:0;flex-direction:column;justify-content:center}.buyhold-primary-heading{display:flex;align-items:baseline;justify-content:space-between;gap:10px;flex-wrap:wrap}.buyhold-primary strong{color:var(--navy);font-size:22px}.buyhold-primary small{display:block;width:100%;margin-top:7px;color:var(--ink);font-size:13px;line-height:1.45;overflow-wrap:anywhere}.buyhold-metrics-rail{display:grid;grid-template-rows:repeat(2,minmax(0,1fr));gap:8px;min-width:0}.buyhold-metric{min-width:0;padding:10px;border:2px solid;border-radius:10px;background:#fff}.buyhold-metric--drawdown{border-color:#ef4444}.buyhold-metric--next{border-color:#22c55e}.buyhold-metric span{display:block;color:var(--muted);font-size:11px}.buyhold-metric b{display:block;margin-top:5px;color:var(--navy);font-size:14px;line-height:1.4;word-break:break-word}.buyhold-gate{display:flex;justify-content:space-between;gap:10px;margin-top:9px;padding:9px 10px;border-radius:10px;background:#eef2ee}.buyhold-gate strong{color:var(--navy);font-size:12px;overflow-wrap:anywhere}.safe { display:flex; align-items:center; justify-content:space-between; gap:12px; padding:13px 14px; border-radius:10px; background:#edf2ed; color:#537260; font-size:13px; }
    ...
    footer { margin-top:24px; color:var(--muted); font-size:11px; text-align:center; }
     @media (max-width:480px) { body { padding:20px 12px 36px; } .card { padding:16px; } .allocation-row { grid-template-columns:96px 1fr 48px; gap:8px; } .risk-grid{grid-template-columns:1fr;gap:8px}.risk-box{padding:12px}.risk-box strong{font-size:24px}.buyhold-primary{grid-template-columns:1fr}.buyhold-metrics-rail{grid-template-rows:auto}.buyhold-primary-heading{align-items:flex-start;flex-direction:column;gap:5px} }
  </style>
</head>
<body>
  <main>
    ...
    <section class="card" aria-labelledby="risk-title">
      ...
      <div class="risk-group buyhold-group">
        ...
        <div class="buyhold-primary"><div class="buyhold-primary-content"><div class="buyhold-primary-heading"><span>當前燈號</span><strong>⚪ 資料暫不可用</strong></div><small>資料不足，暫停買進</small></div><div class="buyhold-metrics-rail"><div class="buyhold-metric buyhold-metric--drawdown"><span>目前回撤</span><b>—</b></div><div class="buyhold-metric buyhold-metric--next"><span>距下一燈</span><b>—</b></div></div></div>
        <div class="buyhold-gate"><span>Portfolio Gate</span><strong>DATA UNAVAILABLE</strong></div>
      </div>
...
<head>
  ...
  <title>Growth Dashboard · Private</title>
   <style>
     .buyhold-group{border-top-color:var(--navy)}.buyhold-primary{display:grid;grid-template-columns:minmax(0,1fr) minmax(150px,.72fr);align-items:stretch;gap:10px;padding:12px 13px;border-radius:12px;background:#f8faf7;border:1px solid #d5ded8}.buyhold-primary-content{display:flex;min-width:0;flex-direction:column;justify-content:center}.buyhold-primary-heading{display:flex;align-items:baseline;justify-content:space-between;gap:10px;flex-wrap:wrap}.buyhold-primary strong{color:var(--navy);font-size:22px}.buyhold-primary small{display:block;width:100%;margin-top:7px;color:var(--ink);font-size:13px;line-height:1.45;overflow-wrap:anywhere}.buyhold-metrics-rail{display:grid;grid-template-rows:repeat(2,minmax(0,1fr));gap:8px;min-width:0}.buyhold-metric{min-width:0;padding:10px;border:2px solid;border-radius:10px;background:#fff}.buyhold-metric--drawdown{border-color:#ef4444}.buyhold-metric--next{border-color:#22c55e}.buyhold-metric span{display:block;color:var(--muted);font-size:11px}.buyhold-metric b{display:block;margin-top:5px;color:var(--navy);font-size:14px;line-height:1.4;word-break:break-word}.buyhold-gate{display:flex;justify-content:space-between;gap:10px;margin-top:9px;padding:9px 10px;border-radius:10px;background:#eef2ee}.buyhold-gate strong{color:var(--navy);font-size:12px;overflow-wrap:anywhere}
    :root { --paper:#f2f0ea; --card:#fbfaf7; --navy:#24425e; --sage:#708a7c; --orange:#c98a4b; --ink:#283d50; --muted:#6d756f; --line:#ddd9d0; }
    * { box-sizing:border-box; } body { margin:0; padding:28px 16px 48px; background:var(--paper); color:var(--ink); font-family:ui-sans-serif,system-ui,-apple-system,"Noto Sans TC",sans-serif; }
    ...
    .private-note { padding:12px 14px; border-radius:9px; background:#fff4df; color:#8b632d; font-size:12px; line-height:1.6; }
     @media(max-width:540px) { body { padding:20px 12px 36px; } .card { padding:16px; } .metrics { grid-template-columns:1fr; } .buyhold-primary{grid-template-columns:1fr}.buyhold-metrics-rail{grid-template-rows:auto}.buyhold-primary-heading{align-items:flex-start;flex-direction:column;gap:5px} }
  </style>
</head>
<body>
  <main>
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.4/dist/chart.umd.min.js"></script>
   <style>
    .buyhold-group{border-top-color:var(--navy)}.buyhold-primary{display:grid;grid-template-columns:minmax(0,1fr) minmax(150px,.72fr);align-items:stretch;gap:10px;padding:12px 13px;border-radius:12px;background:#f8faf7;border:1px solid #d5ded8}.buyhold-primary-content{display:flex;min-width:0;flex-direction:column;justify-content:center}.buyhold-primary-heading{display:flex;align-items:baseline;justify-content:space-between;gap:10px;flex-wrap:wrap}.buyhold-primary strong{color:var(--navy);font-size:22px}.buyhold-primary small{display:block;margin-top:7px;color:var(--ink);font-size:12px;line-height:1.45;overflow-wrap:anywhere}.buyhold-metrics-rail{display:grid;grid-template-rows:repeat(2,minmax(0,1fr));gap:8px;min-width:0}.buyhold-metric{min-width:0;padding:10px;border:2px solid;border-radius:10px;background:#fff}.buyhold-metric--drawdown{border-color:#ef4444}.buyhold-metric--next{border-color:#22c55e}.buyhold-metric span{display:block;color:var(--muted);font-size:11px}.buyhold-metric b{display:block;margin-top:5px;color:var(--navy);font-size:14px;line-height:1.4;word-break:break-word}.buyhold-gate{display:flex;justify-content:space-between;gap:10px;margin-top:9px;padding:9px 10px;border-radius:10px;background:#eef2ee}.buyhold-gate strong{color:var(--navy);font-size:12px;overflow-wrap:anywhere}
...
<body>
<main>
  <style>@media(max-width:560px){.buyhold-primary{grid-template-columns:1fr}.buyhold-metrics-rail{grid-template-rows:auto}.buyhold-primary-heading{align-items:flex-start;flex-direction:column;gap:3px}.buyhold-primary strong{font-size:19px}}</style>
...
(() => {
  ...
  const render = (body) => { const data=body.data||{}; const p=data.portfolio||{}; const risk=p.risk||{}; const netValue=Number(p.netAsset); const totalValue=Number(p.totalAsset); $('netAsset').textContent=Number.isFinite(netValue)?money(netValue):'—'; $('equityRatio').textContent=ratioText(netValue,totalValue); $('equityRatio').setAttribute('aria-label','淨資產占總資產 '+ratioText(netValue,totalValue)); $('totalAsset').textContent=money(totalValue); $('totalDebt').textContent=money(p.totalDebt); $('debtRatio').textContent=pct(risk.debtRatio); $('sync').textContent=syncText(body.generatedAt||data.lastUpdated); const perf=p.performance||{}; const diff=Number(perf.netChange); const diffPct=Number(perf.netChangePercent); const daily=$('dailyChange'); if(Number.isFinite(diff)&&Number.isFinite(diffPct)){daily.textContent='今日 '+(diff>=0?'+':'')+pct(diffPct)+' · '+(diff>=0?'+':'')+money(diff); daily.style.color=diff>=0?'#f1a08b':'#9bc1a8';}else{daily.textContent='今日 —'; daily.style.color='#dbe5e5';}
    ...
    const buyHold=p.buyHold||data.buyHold||{}; const bhLight=buyHold.light||{}; const bhNext=bhLight.nextLight||{}; const bhRec=buyHold.recommendation||{}; const bhGate=buyHold.portfolioGate||{}; const bhCode=String(bhLight.code||'UNAVAILABLE').toUpperCase(); $('buyHoldLight').textContent=`${bhLight.emoji||'⚪'} ${bhLight.name||'資料暫不可用'}`; $('buyHoldMeaning').textContent=bhCode==='UNAVAILABLE'?'資料不足，暫停買進':`${bhLight.meaning||'資料暫不可用'} · ${bhRec.action||'維持持有'}`; $('buyHoldDrawdown').textContent=Number.isFinite(Number(bhLight.dd240Pct))?`${Number(bhLight.dd240Pct).toFixed(1)}%`:'—'; $('buyHoldNextLabel').textContent=bhCode==='RED'?'目前已達最高機會級別':`距${bhNext.name||'下一燈'}`; $('buyHoldNextDistance').textContent=Number.isFinite(Number(bhNext.distancePct))?`${(Number(bhNext.distancePct)*100).toFixed(1)}%`:'—'; $('buyHoldGate').textContent=bhGate.status||'DATA UNAVAILABLE';
