  ...
  <main>
    ...
    <section class="card" aria-labelledby="risk-title">
      ...
      <div class="risk-group buyhold-group">
        ...
        <div class="buyhold-primary"><div class="buyhold-primary-heading"><span>當前燈號</span><strong>⚪ 資料暫不可用</strong></div><small>資料不足，暫停買進</small></div>
        <div class="buyhold-info-grid"><div><span>目前回撤</span><b>—</b></div><div><span>距下一燈</span><b>—</b></div></div>
  ...
  <title>Growth Dashboard · Private</title>
    ...
    * { box-sizing:border-box; } body { margin:0; padding:28px 16px 48px; background:var(--paper); color:var(--ink); font-family:ui-sans-serif,system-ui,-apple-system,"Noto Sans TC",sans-serif; }
    ...
    .private-note { padding:12px 14px; border-radius:9px; background:#fff4df; color:#8b632d; font-size:12px; line-height:1.6; }
     @media(max-width:540px) { body { padding:20px 12px 36px; } .card { padding:16px; } .metrics { grid-template-columns:1fr; } .buyhold-info-grid{grid-template-columns:1fr}.buyhold-primary-heading{align-items:flex-start;flex-direction:column;gap:5px} }
  </style>
</head>
<body>
  <main>
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.4/dist/chart.umd.min.js"></script>
   <style>
    .buyhold-group{border-top-color:var(--navy)}.buyhold-primary{display:block;padding:12px 13px;border-radius:12px;background:#f8faf7;border:1px solid #d5ded8}.buyhold-primary-heading{display:flex;align-items:baseline;justify-content:space-between;gap:10px;flex-wrap:wrap}.buyhold-primary strong{color:var(--navy);font-size:22px}.buyhold-primary small{display:block;margin-top:7px;color:var(--ink);font-size:12px;line-height:1.45;overflow-wrap:anywhere}.buyhold-info-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:9px}.buyhold-info-grid>div{min-width:0;padding:10px;border:1px solid #d5ded8;border-radius:10px;background:#f8faf7}.buyhold-info-grid span,.buyhold-gate span{color:var(--muted);font-size:11px}.buyhold-info-grid b{display:block;margin-top:5px;color:var(--navy);font-size:14px;line-height:1.4;word-break:break-word}.buyhold-gate{display:flex;justify-content:space-between;gap:10px;margin-top:9px;padding:9px 10px;border-radius:10px;background:#eef2ee}.buyhold-gate strong{color:var(--navy);font-size:12px;overflow-wrap:anywhere}
...
<body>
<main>
  <style>@media(max-width:560px){.buyhold-primary-heading{align-items:flex-start;flex-direction:column;gap:3px}.buyhold-info-grid{grid-template-columns:1fr}.buyhold-primary strong{font-size:19px}}</style>
