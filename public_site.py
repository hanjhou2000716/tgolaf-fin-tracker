...
DEMO_DATA = {
    ...
    "portfolio": {
        ...
        "buyHold": {"status": "UNAVAILABLE", "light": {"code": "UNAVAILABLE", "name": "資料暫不可用", "emoji": "⚪", "meaning": "Opportunity Buy disabled"}, "recommendation": {"action": "Opportunity Buy disabled"}, "portfolioGate": {"status": "DATA UNAVAILABLE"}},
    },
}
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .percent { color:var(--navy); font-variant-numeric:tabular-nums; text-align:right; font-weight:700; }
     .risk-group{padding:15px;border:1px solid #e3dfd6;border-radius:14px;background:#f4f2ed}.risk-group+.risk-group{margin-top:12px}.risk-group-title{display:flex;justify-content:space-between;align-items:baseline;margin-bottom:11px;font:700 17px Georgia,"Noto Serif TC",serif}.risk-group-title span{font:400 11px ui-sans-serif,sans-serif;color:var(--muted)}.risk-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.risk-box{min-width:0;padding:15px;border:1px solid #d5ded8;border-radius:12px;background:#f8faf7}.risk-box label{display:block;color:var(--muted);font-size:12px;font-weight:700}.risk-box strong{display:block;margin-top:7px;color:var(--navy);font-size:28px;line-height:1.1;letter-spacing:-.02em}.risk-divider{border:0;border-top:1px solid #d5ddd5;margin:12px 0 10px}.risk-card-detail,.risk-card-subdetail,.risk-card-status{display:block;line-height:1.45}.risk-card-detail{color:var(--ink);font-size:13px;font-weight:700}.risk-card-subdetail{margin-top:4px;color:var(--muted);font-size:12px}.risk-card-status{margin-top:8px;font-size:12px;font-weight:700}.risk-box strong.alert{color:var(--brick)}.risk-badge{display:inline-block;margin-top:5px;padding:4px 9px;border-radius:999px;background:#eadcad;color:#936a28;font-weight:800}.buyhold-primary{display:flex;align-items:baseline;justify-content:space-between;gap:10px;flex-wrap:wrap;padding:12px 13px;border-radius:12px;background:#f8faf7;border:1px solid #d5ded8}.buyhold-primary strong{color:var(--navy);font-size:22px}.buyhold-primary small{width:100%;color:var(--ink);font-size:12px}.buyhold-info-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:9px}.buyhold-info-grid>div{min-width:0;padding:10px;border:1px solid #d5ded8;border-radius:10px;background:#f8faf7}.buyhold-info-grid span,.buyhold-gate span{color:var(--muted);font-size:11px}.buyhold-info-grid b{display:block;margin-top:5px;color:var(--navy);font-size:14px;line-height:1.4;word-break:break-word}.buyhold-gate{display:flex;justify-content:space-between;gap:10px;margin-top:9px;padding:9px 10px;border-radius:10px;background:#eef2ee}.buyhold-gate strong{color:var(--navy);font-size:12px}.safe { display:flex; align-items:center; justify-content:space-between; gap:12px; padding:13px 14px; border-radius:10px; background:#edf2ed; color:#537260; font-size:13px; }
  ...
  <main>
    ...
    <section class="card" aria-labelledby="risk-title">
      ...
      <div class="risk-group buyhold-group">
        ...
        <div class="buyhold-primary"><span>當前燈號</span><strong>⚪ 資料暫不可用</strong><small>Opportunity Buy disabled</small></div>
        <div class="buyhold-info-grid"><div><span>目前回撤</span><b>—</b></div><div><span>距下一燈</span><b>—</b></div><div><span>建議動作</span><b>Opportunity Buy disabled</b></div></div>
  ...
  <title>Growth Dashboard · Private</title>
    ...
    * { box-sizing:border-box; } body { margin:0; padding:28px 16px 48px; background:var(--paper); color:var(--ink); font-family:ui-sans-serif,system-ui,-apple-system,"Noto Sans TC",sans-serif; }
    ...
    .private-note { padding:12px 14px; border-radius:9px; background:#fff4df; color:#8b632d; font-size:12px; line-height:1.6; }
     @media(max-width:540px) { body { padding:20px 12px 36px; } .card { padding:16px; } .metrics { grid-template-columns:1fr; } .buyhold-info-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.buyhold-info-grid>div:last-child{grid-column:1 / -1} }
  </style>
</head>
<body>
  <main>
...
<body>
<main>
  <style>@media(max-width:560px){.buyhold-info-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.buyhold-info-grid>div:last-child{grid-column:1 / -1}.buyhold-primary strong{font-size:19px}}</style>
