  ...
  <title>Growth Dashboard · Private</title>
    ...
    * { box-sizing:border-box; } body { margin:0; padding:28px 16px 48px; background:var(--paper); color:var(--ink); font-family:ui-sans-serif,system-ui,-apple-system,"Noto Sans TC",sans-serif; }
    ...
    .private-note { padding:12px 14px; border-radius:9px; background:#fff4df; color:#8b632d; font-size:12px; line-height:1.6; }
     @media(max-width:540px) { body { padding:20px 12px 36px; } .card { padding:16px; } .metrics { grid-template-columns:1fr; } .buyhold-primary{grid-template-columns:minmax(0,1fr) minmax(112px,.62fr);gap:8px;padding:10px}.buyhold-metric{padding:9px 8px}.buyhold-primary-heading{align-items:flex-start;flex-direction:column;gap:5px}.buyhold-primary strong{font-size:28px} } @media(max-width:359px) { .buyhold-primary{grid-template-columns:1fr}.buyhold-metrics-rail{grid-template-rows:auto auto} }
  </style>
</head>
<body>
  <main>
...
<body>
<main>
  <style>@media(max-width:540px){.buyhold-primary{grid-template-columns:minmax(0,1fr) minmax(112px,.62fr);gap:8px;padding:10px}.buyhold-metric{padding:9px 8px}.buyhold-primary-heading{align-items:flex-start;flex-direction:column;gap:3px}.buyhold-primary strong{font-size:28px}}@media(max-width:359px){.buyhold-primary{grid-template-columns:1fr}.buyhold-metrics-rail{grid-template-rows:auto auto}}</style>
