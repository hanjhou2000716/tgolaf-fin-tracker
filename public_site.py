...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    @media (max-width:480px) { body { padding:20px 12px 36px; } .card { padding:16px; } .allocation-row { grid-template-columns:96px 1fr 48px; gap:8px; } .risk-grid{grid-template-columns:1fr;gap:8px}.risk-box{padding:12px}.risk-box strong{font-size:24px} }
  </style>
</head>
<body>
  <main>
