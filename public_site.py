...
BUYHOLD_LAMP_CSS = """
    ...
    .buyhold-metrics-panel{display:grid;grid-template-rows:auto 1px auto;align-content:stretch;min-width:0;gap:0;padding:10px 11px;border:2px solid #94a3b8;border-radius:12px;background:#fff}
    ...
    .buyhold-metric{min-width:0;padding:2px 0;border:0;background:transparent}
    .buyhold-metrics-divider{height:1px;margin:8px 0;background:#d5ddd5}
    ...
    @media(max-width:540px){.buyhold-primary{grid-template-columns:minmax(0,1fr) minmax(112px,.62fr);gap:8px;padding:10px}.buyhold-primary-content{gap:8px}.buyhold-metrics-panel{padding:9px 8px}.buyhold-metrics-divider{margin:7px 0}}
