...
<main>
  ...
  <div id="dashboard" hidden>
    ...
    <section class="section"><div class="section-heading"><h2>資料健康</h2><span>Data health</span></div><details class="card health-card"><summary class="card-title health-summary"><span>資料品質檢查</span><span id="healthSummary" class="card-note">點擊展開</span></summary><div id="health" class="health"></div><div id="advisor" class="subtle"></div></details></section>
    <section class="section"><div class="section-heading"><h2>最近資產更新</h2><span>Transaction status</span></div><div class="card"><div id="transactionIngestion" class="ingestion-list" aria-live="polite"></div></div></section>
