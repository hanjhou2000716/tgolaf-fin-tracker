  ...
  <main>
    ...
    <section class="card" aria-labelledby="risk-title">
      ...
      <div class="risk-group">
        ...
        <div class="risk-grid">
          <div class="risk-box"><label class="risk-card-label">Beta</label><strong class="risk-card-value">— ×</strong><hr class="risk-divider"><span class="risk-card-detail">凱利安全邊界 — ×</span><span class="risk-card-subdetail">(容量：—)</span><span class="risk-card-status risk-badge">僅示範</span></div>
