...
<main>
  ...
  <div id="dashboard" hidden>
    <section class="hero"><div class="hero-header"><p class="eyebrow">Portfolio overview</p><span id="sync" class="sync-meta">資料同步 · —</span></div><div class="hero-line"><div><div class="hero-label">淨資產 Net</div><div id="netAsset" class="hero-value">—</div></div><div class="equity-ratio"><span>股權比</span><strong id="equityRatio">—</strong></div></div><div class="status-row"><span id="dailyChange" class="pill">今日 —</span></div><div class="metrics"><div class="metric"><span>總資產</span><strong id="totalAsset">—</strong></div><div class="metric"><span>總負債</span><strong id="totalDebt">—</strong></div><div class="metric"><span>負債比</span><strong id="debtRatio">—</strong></div></div></section>
