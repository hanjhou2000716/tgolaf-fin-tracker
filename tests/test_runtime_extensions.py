...
class RuntimeExtensionTests(unittest.TestCase):
    def test_snapshot_drives_all_private_sections(self):
        ...
        self.assertEqual(result["goalForecast"]["activeGoal"]["id"], "G1_TWD_10M")
        self.assertEqual(result["goalForecast"]["probabilityDefinition"], "hit_by_deadline")
        self.assertEqual(result["goalForecast"]["paths"], 5000)
