...
def main():
    ...
    buy_hold_section_html = f'''<div class="risk-section buyhold-section" id="buyhold">
                ...
                <div class="buyhold-primary"><div class="buyhold-primary-heading"><span>當前燈號</span><strong>{bh_light_text}</strong></div><small>{bh_action_text}</small></div>
                <div class="buyhold-info-grid"><div><span>目前回撤</span><b>{bh_dd_text}</b></div><div><span>距{bh_next_name if bh_next_name != "—" else "下一燈"}</span><b>{bh_distance_text}</b></div></div>
    ...
    data_for_web = {
        ...
        "portfolio": {
            ...
            "usLargest": {
                ...
                "percent": round(us_largest_pct, 1),
            },
            ...
            "history": {
                ...
                "totals": chart_totals,
                "nets": chart_nets,
                "totalMonthly": total_20ma,
                "totalQuarterly": total_60ma,
                "totalYearly": total_240ma,
                "netMonthly": net_20ma,
                "netQuarterly": net_60ma,
                "netYearly": net_240ma,
            },
            "categoryDailyChanges": category_daily_changes,
            "performance": {**performance, "netChangePercent": round(daily_pct, 2)},
